...
export const InputBase: React.FC<InputBaseProps> = (props) => {
  ...
  return (
    <InputBaseWrapper isActive={isFocused} isCompact={props.compact}>
      ...
      >
        {props.prefixIcon && (
          <InputPrefixIconWrapper name={props.prefixIcon} size={18} color={theme.colors.text.muted} />
        )}
        <InputStyle
          {...props}
          onFocus={onFocus}
        ...
        />
        {props.suffixIcon && (
          <InputSuffixIconWrapper name={props.suffixIcon} size={18} color={theme.colors.text.muted} />
        )}
      </Pressable>
    </InputBaseWrapper>
  );
